...
func (in *MachineDeploymentStatus) DeepCopyInto(out *MachineDeploymentStatus) {
	*out = *in
	...
	if in.PreservedMachines != nil {
		in, out := &in.PreservedMachines, &out.PreservedMachines
		*out = make([]*PreservedMachineSummary, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PreservedMachineSummary)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreservedMachineSummary) DeepCopyInto(out *PreservedMachineSummary) {
	*out = *in
	in.LastOperation.DeepCopyInto(&out.LastOperation)
	if in.PreserveExpiryTime != nil {
		in, out := &in.PreserveExpiryTime, &out.PreserveExpiryTime
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreservedMachineSummary.
func (in *PreservedMachineSummary) DeepCopy() *PreservedMachineSummary {
	if in == nil {
		return nil
	}
	out := new(PreservedMachineSummary)
