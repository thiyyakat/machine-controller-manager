...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PreservedMachineSummary)(nil), (*machine.PreservedMachineSummary)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_PreservedMachineSummary_To_machine_PreservedMachineSummary(a.(*PreservedMachineSummary), b.(*machine.PreservedMachineSummary), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.PreservedMachineSummary)(nil), (*PreservedMachineSummary)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_PreservedMachineSummary_To_v1alpha1_PreservedMachineSummary(a.(*machine.PreservedMachineSummary), b.(*PreservedMachineSummary), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_MachineDeploymentStatus_To_machine_MachineDeploymentStatus(in *MachineDeploymentStatus, out *machine.MachineDeploymentStatus, s conversion.Scope) error {
	...
	out.PreservedMachines = *(*[]*machine.PreservedMachineSummary)(unsafe.Pointer(&in.PreservedMachines))
	return nil
}
...
func autoConvert_machine_MachineDeploymentStatus_To_v1alpha1_MachineDeploymentStatus(in *machine.MachineDeploymentStatus, out *MachineDeploymentStatus, s conversion.Scope) error {
	...
	out.PreservedMachines = *(*[]*PreservedMachineSummary)(unsafe.Pointer(&in.PreservedMachines))
	return nil
}
...
func autoConvert_v1alpha1_PreservedMachineSummary_To_machine_PreservedMachineSummary(in *PreservedMachineSummary, out *machine.PreservedMachineSummary, s conversion.Scope) error {
	out.Name = in.Name
	out.ProviderID = in.ProviderID
	out.Phase = machine.MachinePhase(in.Phase)
	if err := Convert_v1alpha1_LastOperation_To_machine_LastOperation(&in.LastOperation, &out.LastOperation, s); err != nil {
...
// Convert_v1alpha1_PreservedMachineSummary_To_machine_PreservedMachineSummary is an autogenerated conversion function.
func Convert_v1alpha1_PreservedMachineSummary_To_machine_PreservedMachineSummary(in *PreservedMachineSummary, out *machine.PreservedMachineSummary, s conversion.Scope) error {
	return autoConvert_v1alpha1_PreservedMachineSummary_To_machine_PreservedMachineSummary(in, out, s)
}

func autoConvert_machine_PreservedMachineSummary_To_v1alpha1_PreservedMachineSummary(in *machine.PreservedMachineSummary, out *PreservedMachineSummary, s conversion.Scope) error {
	out.Name = in.Name
	out.ProviderID = in.ProviderID
	out.Phase = MachinePhase(in.Phase)
	if err := Convert_machine_LastOperation_To_v1alpha1_LastOperation(&in.LastOperation, &out.LastOperation, s); err != nil {
...
// Convert_machine_PreservedMachineSummary_To_v1alpha1_PreservedMachineSummary is an autogenerated conversion function.
func Convert_machine_PreservedMachineSummary_To_v1alpha1_PreservedMachineSummary(in *machine.PreservedMachineSummary, out *PreservedMachineSummary, s conversion.Scope) error {
	return autoConvert_machine_PreservedMachineSummary_To_v1alpha1_PreservedMachineSummary(in, out, s)
}
